...
KINC_FUNC void mat4_look_at(mat4_t* self, vec3_t* eye, vec3_t* at, vec3_t* up);
 ...
 **/
KINC_FUNC void mat4_multvec(mat4_t* self, vec4_t* value, vec4_t* product);
/**
...
**/
KINC_FUNC void mat4_setLoc(mat4_t* self, vec4_t* v);
/**
...
**/
KINC_FUNC void mat4_applyScale(mat4_t* self, vec4_t* v);
/**
...
**/
KINC_FUNC void mat4_getLoc(mat4_t* self, vec4_t* v);
/**
    Get the scale component.
    @param self This matrix
    @param v The vector to put the scale data
**/
KINC_FUNC void mat4_getScale(mat4_t* self, vec4_t* v);
/**
...
**/
KINC_FUNC void  mat4_right(mat4_t* self, vec4_t* v);
/**
...
**/
KINC_FUNC void  mat4_look(mat4_t* self, vec4_t* v);
/**
 * Sets the vector to the positive z axis of the space defined by this matrix.
 * @param self This matrix
 * @param v The vector to be set to the up vector
**/
KINC_FUNC kinc_matrix4x4_t mat4_to_kinc_matrix4x4(mat4_t* self);

KINC_FUNC void mat4_print(mat4_t* self);
